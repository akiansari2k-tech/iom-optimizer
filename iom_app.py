...
def hydro_forces(Vb, F_side):
    ...
    R = 0.5 * RHO_WATER * CD_h * KEEL_AREA * Vb ** 2 + 0.50 * Vb ** 2
    return R
...
def optimise_trim_for_vmg(TWS):
    ...
    def objective(x):
        TWA, main_sheet, main_twist, main_camber, jib_sheet, jib_twist, jib_camber = x
    ...
    TWA, main_sheet, main_twist, main_camber, jib_sheet, jib_twist, jib_camber = result.x
    ...
    return {
        ...
        "main_twist": main_twist,
        "main_camber": main_camber,
        "jib_sheet": jib_sheet,
        "jib_twist": jib_twist,
        "jib_camber": jib_camber,
        "Vb": Vb,
        "heel": heel,
        "VMG": VMG,
    }
